...
class _DynamicFormState extends State<DynamicForm> {
  ...
  Widget build(BuildContext context) {
    final visibleFields = widget.fields.where((field) {
      ...
      return _formData[dependencyKey] == dependencyValue;
    }).toList();
    ...
    switch (field.type) {
      case 'text':
        return TextFormField(
         key: ValueKey('pluginForm_textfield_${field.key}'),
        ...
        return Container(
          ...
          child: Row(
            children: [
              ...
              Switch(
                key: ValueKey('pluginForm_switch_${field.key}'),
                value: value == true,
                onChanged: (val) => _updateField(field.key, val),
      ...
      case 'dropdown':
        return DropdownButtonFormField<String>(
          key: ValueKey('pluginForm_dropdown_${field.key}'),
      ...
      case 'date':
        return InkWell(
         key: ValueKey('pluginForm_datepicker_${field.key}'),
          onTap: () async {

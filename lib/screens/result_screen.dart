...
//                         child: ClipRRect(
//                           borderRadius: BorderRadius.circular(12),
//                           child: Image.memory(base64ImageBytes, fit: BoxFit.cover),
//                         ),
//                       ),
//                     ],
//                   ),
...
//             decoration: BoxDecoration(
//               color: const Color(0xFFFFF3E0), // Hex: #FFF3E0 (light orange)
//               borderRadius: BorderRadius.circular(12),
//               border: Border.all(color: const Color(0xFFFFCC80)), // Hex: #FFCC80
//             ),
//             child: Column(
//               children: [
...
//         // Scrollable device info section
//         Expanded(
//           child: SingleChildScrollView(
//             child: Column(
//               crossAxisAlignment: CrossAxisAlignment.start,
//               children: result.entries
//                   .where((e) => e.key != 'logs') // Skip logs key
...
//           );
//         } else {
//           content = const Text('QR code not generated.');
//         }
//         break;
// // case 'qr':

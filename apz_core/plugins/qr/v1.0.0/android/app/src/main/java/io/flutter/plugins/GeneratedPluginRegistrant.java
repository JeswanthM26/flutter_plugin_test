...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    try {
      flutterEngine.getPlugins().add(new com.iexceed.apz_photopicker.ApzPhotopicker());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin apz_photopicker, com.iexceed.apz_photopicker.ApzPhotopicker", e);
    }
    try {

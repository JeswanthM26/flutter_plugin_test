package com.iexceed.apz_inapp_update
...
class InAppUpdate : FlutterPlugin, MethodCallHandler,
    ...
    companion object {
        ...
        private const val CHANNEL_METHODS = "apz_inapp_update/methods"
        private const val CHANNEL_EVENTS = "apz_inapp_update/stateEvents"
    }
    ...
    override fun onAttachedToEngine(flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
        channel = MethodChannel(flutterPluginBinding.binaryMessenger, CHANNEL_METHODS)
        channel.setMethodCallHandler(this)

        event = EventChannel(flutterPluginBinding.binaryMessenger, CHANNEL_EVENTS)

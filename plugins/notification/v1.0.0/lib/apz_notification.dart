...
typedef ApzNotificationOnMessageCallback = 
...
typedef ApzNotificationOnTokenRefreshCallback =
void Function(String newToken);
 ...
 Future<void> initializePushNotification({
  ...
  if (Firebase.apps.isEmpty) {
    if (firebaseOptions != null) {
      ...
      _logger.debug("APZPN: Warning: FirebaseOptions not provided. "
...
Future<void> showLocalNotification({
  ...
  static Future<void> _firebaseMessagingBackgroundHandler(
    ...
    await _backgroundMessageHandler?.call(ApzMessage.fromRemoteMessage(message));
  }
  ...
  Future<void> _requestPermissions() async {
    ...
    _logger.debug("APZPN: User granted permission: "

...
class NativeWrapperContacts {
  ...
  MethodChannel("com.iexceed/contacts_plugin");

  /// Fetch list of name and email
  Future<List<Map<String, dynamic>>> getContacts({
      final bool? fetchEmail,
      final bool? fetchPhoto, final String? searchQuery,}) async {
    try {
      ...
      return contacts.map((final contact) =>
      Map<String, dynamic>.from(contact),).toList();

...
class _WebviewScreenState extends State<WebviewScreen> {
  ...
  Future<WebViewController> _getWebViewController(
    ...
    final NavigationDelegate delegate = NavigationDelegate(
      ...
      onWebResourceError: (final WebResourceError error) => <Set<void>>{
        if (onError != null) <void>{onError(error.description)},
      },
      onHttpError: (final HttpResponseError error) => <Set<void>>{
        if (onError != null) <void>{onError(error.toString())},
      },

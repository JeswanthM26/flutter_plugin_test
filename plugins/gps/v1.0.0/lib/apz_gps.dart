...
/// A class to handle GPS functionalities, including fetching the current location.
/// It checks for location permissions and services before attempting to retrieve the location.
class ApzGPS {
  ...
  /// Evaluates the permission status and throws an exception if the permission is not granted.
  ...
  void _evaluatePermission(PermissionStatus status, String label) {
    switch (status) {
